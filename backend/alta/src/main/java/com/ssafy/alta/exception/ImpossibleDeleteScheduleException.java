 ...
 */
public class ImpossibleDeleteScheduleException extends BusinessException  {
    public ImpossibleDeleteScheduleException() { super(ErrorCode.IMPOSSIBLE_DELETE_SCHEDULE);}
}
